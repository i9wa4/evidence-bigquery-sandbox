...
Lift above 1 means positive affinity; lift below 1 means customers rarely combine those categories.
...
- **Lift below 1.0**: negative affinity — customers rarely buy both in the same order.
