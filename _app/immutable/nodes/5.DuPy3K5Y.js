import{s as ve,R as it,l as ze,S as yt,q as we,C as Pe,F as Ve,d as O,G as Je,H as je,I as Qe,i as S,c as H,j as P,f as Ge,U as We,V as nt,a as qe,b as Re,h as bt,e as De,g as Fe,k as Ie,m as ht,o as Ot,n as Rt,p as pt}from"../chunks/scheduler.DClYbTPH.js";import{S as Be,i as ke,d as Z,t as y,a as m,m as x,b as $,e as ee,g as Ue,c as Me}from"../chunks/index.zouyAMnr.js";import{y as St,z as Ct,g as Ke,A as Ne,a4 as Tt,B as pe,w as He,M as Et,N as Nt,G as At,O as Dt,R as mt,S as It,Q as Ae,U as Ut,V as Mt,W as Ft,D as Lt,e as wt,s as vt,p as Bt,r as lt,C as kt}from"../chunks/VennDiagram.svelte_svelte_type_style_lang.DmhKrLhI.js";import{w as Ht}from"../chunks/entry.C7GTRzGn.js";import{h as Ee,p as Pt}from"../chunks/setTrackProxy.DjIbdjlZ.js";import{D as Gt}from"../chunks/Dropdown.C-c2Gniu.js";import{p as Yt}from"../chunks/stores.BN5ALBdz.js";import{C as qt,E as zt,Q as Le}from"../chunks/Chart.WoBQ-YRp.js";import{B as Wt}from"../chunks/BarChart.C2KPDZRT.js";import{g as Vt,a as Jt}from"../chunks/getCompletedData.DeELVCDy.js";import{H as jt}from"../chunks/Heatmap.CdoUfAeI.js";import{H as Qt}from"../chunks/Histogram.CNLpYZJQ.js";import{S as Kt}from"../chunks/ScatterPlot.DxQ6kJHi.js";function Xt(i,t,e){let r,a,o,l,c,d,g,z,h,w,de,ye,Q,W,F,I,K,ne,V=we,se=()=>(V(),V=Pe(a,_=>e(29,ne=_)),a),be,L=we,ce=()=>(L(),L=Pe(r,_=>e(30,be=_)),r),T;i.$$.on_destroy.push(()=>V()),i.$$.on_destroy.push(()=>L());let me=it(St);ze(i,me,_=>e(31,T=_));let ue=it(Ct);const{resolveColor:Ce}=Ke();let{y:b=void 0}=t;const Se=!!b;let{series:G=void 0}=t;const le=!!G;let{options:v=void 0}=t,{size:Y=void 0}=t,{name:B=void 0}=t,{shape:N=void 0}=t,{fillColor:q=void 0}=t,{opacity:te=.7}=t,{outlineColor:re=void 0}=t,{outlineWidth:ge=void 0}=t,M=35,{scaleTo:fe=1}=t,{useTooltip:oe=!1}=t,{tooltipTitle:J}=t,{seriesOrder:ie=void 0}=t,{seriesLabelFmt:ae=void 0}=t,A,j;function he(_){const R=_[2];return Math.sqrt(R/Q*W)}let _e,X;return oe&&(_e={tooltip:{formatter:function(R){return A?J?j=`<span id="tooltip" style='font-weight:600'>${pe(R.value[3],"0")}</span><br/>
                            ...
                            ${Ne(Y,h)} <span style='font-weight: 400;'> (size)</span>: <span style='float:right; margin-left: 15px;'>${pe(R.value[2],h)}</span>`:j=`<span id="tooltip" style='font-weight:600'>${pe(R.seriesName)}</span><br/>
                            ${Ne(l,g)}: <span style='float:right; margin-left: 15px;'>${pe(R.value[0],g)}</span><br/>
                            ${Ne(typeof b=="object"?R.seriesName:b,z)}: <span style='float:right; margin-left: 15px;'>${pe(R.value[1],z)}</span><br/>
                            ${Ne(Y,h)} <span style='font-weight: 400;'> (size)</span>: <span style='float:right; margin-left: 15px;'>${pe(R.value[2],h)}</span>`:J?j=`<span id="tooltip" style='font-weight:600;'>${pe(R.value[3],"0")}</span><br/>
...
FROM order_items
GROUP BY status
ORDER BY orders DESC`;l.order_funnel_data&&(l.order_funnel_data instanceof Error?w.initialError=l.order_funnel_data:w.initialData=l.order_funnel_data,l.order_funnel_columns&&(w.knownColumns=l.order_funnel_columns));let Q,W=!1;const F=Ae.createReactive({callback:u=>{e(1,Q=u)},execFn:h},{id:"order_funnel",...w});F(ye,{noResolve:de,...w}),globalThis[Symbol.for("order_funnel")]={get value(){return Q}};let I={initialData:void 0,initialError:void 0},K=Ee`SELECT
  p.category,
...
GROUP BY p.brand
ORDER BY revenue DESC
LIMIT 10`;l.category_brand_revenue_data&&(l.category_brand_revenue_data instanceof Error?M.initialError=l.category_brand_revenue_data:M.initialData=l.category_brand_revenue_data,l.category_brand_revenue_columns&&(M.knownColumns=l.category_brand_revenue_columns));let J,ie=!1;const ae=Ae.createReactive({callback:u=>{e(6,J=u)},execFn:h},{id:"category_brand_revenue",...M});ae(oe,{noResolve:fe,...M}),globalThis[Symbol.for("category_brand_revenue")]={get value(){return J}};let A={initialData:void 0,initialError:void 0},j=Ee`SELECT
  p.brand,
  p.category,
...
HAVING units_sold > 100
ORDER BY total_revenue DESC
LIMIT 50`;l.price_vs_revenue_data&&(l.price_vs_revenue_data instanceof Error?A.initialError=l.price_vs_revenue_data:A.initialData=l.price_vs_revenue_data,l.price_vs_revenue_columns&&(A.knownColumns=l.price_vs_revenue_columns));let _e,X=!1;const _=Ae.createReactive({callback:u=>{e(7,_e=u)},execFn:h},{id:"price_vs_revenue",...A});_(he,{noResolve:j,...A}),globalThis[Symbol.for("price_vs_revenue")]={get value(){return _e}};let R={initialData:void 0,initialError:void 0},Te=Ee`SELECT
  o.order_id,
...
GROUP BY p.brand
ORDER BY revenue DESC
LIMIT 10`),i.$$.dirty[1]&15&&(fe||!ie?fe||(ae(oe,{noResolve:fe,...M}),e(34,ie=!0)):ae(oe,{noResolve:fe})),i.$$.dirty[1]&240&&(j||!X?j||(_(he,{noResolve:j,...A}),e(38,X=!0)):_(he,{noResolve:j})),i.$$.dirty[1]&3840&&(Te||!C?Te||(D(Oe,{noResolve:Te,...R}),e(42,C=!0)):D(Oe,{noResolve:Te}))},e(12,de=Ee`SELECT
  status,
  COUNT(*) AS orders
FROM order_items
GROUP BY status
...
HAVING total_orders > 50
ORDER BY total_revenue DESC
LIMIT 40`),e(24,Se=Ee`SELECT DISTINCT category FROM products ORDER BY category`),e(25,G="SELECT DISTINCT category FROM products ORDER BY category"),e(36,j=Ee`SELECT
  p.brand,
  p.category,
  ROUND(AVG(p.retail_price), 2) AS avg_retail_price,
  ROUND(SUM(oi.sale_price), 2) AS total_revenue,
...
JOIN order_items oi ON o.order_id = oi.order_id
WHERE oi.status NOT IN ('Cancelled', 'Returned')
GROUP BY o.order_id`),[g,Q,V,me,le,te,J,_e,U,o,l,w,de,ye,W,I,K,ne,se,L,ce,T,ue,b,Se,G,v,B,N,q,re,M,fe,oe,ie,A,j,he,X,R,Te,Oe,C,r]}class Fr extends Be{constructor(t){super(),ke(this,t,hr,br,ve,{data:9},null,[-1,-1])}}export{Fr as component};
