import{s as $r,d as a,i,a as Lt,b as h,c as m,h as br,e as p,f as cr,g as N,j as c,k as E,l as ur,m as wr,o as kr,n as Mr,p as Hr,r as Ur,t as Lr,q as ct}from"../chunks/scheduler.BTKi2gVA.js";import{S as Fr,i as Ir,d as R,t as f,a as u,c as ye,m as g,b as S,e as A,g as Oe}from"../chunks/index.CW7jRlKo.js";import{D as qr,e as Br,s as Vr,Q as De,p as Gr,r as fr,C as Wr}from"../chunks/VennDiagram.svelte_svelte_type_style_lang.CtIUMu04.js";import{w as Yr}from"../chunks/entry.l9tuWSNy.js";import{h as M,p as zr}from"../chunks/setTrackProxy.DjIbdjlZ.js";import{p as Pr}from"../chunks/stores.DT18Nv0f.js";import{N as xr,D as Ft}from"../chunks/Note.oo3jY3_L.js";import{E as Xr,Q as $e}from"../chunks/Chart.DYs1XbJB.js";import{B as hr}from"../chunks/BarChart.Afe0BP_o.js";import{B as rt}from"../chunks/BigValue.BDkooNrJ.js";import{H as Qr}from"../chunks/Heatmap.DU82Cyi0.js";import{L as vr}from"../chunks/LineChart.sMv6D1JH.js";import{S as jr}from"../chunks/ScatterPlot.DSr03cDX.js";function Jr(s){return{c(){this.h()},l(o){this.h()},h(){document.title="Evidence"},m:ct,p:ct,d:ct}}function Kr(s){let o;return{c(){o=Lr(`Cohorts are defined by the month of a customer's first completed purchase.
...
Steeper curves indicate higher-value cohorts.`,Ge,d,pe,dt,We,pt,ut,Et,Se,It='<a href="#rfm-customer-segmentation">RFM Customer Segmentation</a>',Rt,lt,it,Ye,gt,ze,St,Pe,At,Ae,qt='<a href="#segment-size--value--treemap">Segment Size &amp; Value — Treemap</a>',Nt,xe,Bt="Each rectangle is sized by customer count; tooltip shows average LTV per segment.",Tt,Xe,Ct,Ne,Vt='<a href="#recency-vs-frequency-scatter-by-segment">Recency vs Frequency Scatter (by Segment)</a>',yt,Qe,Gt=`Each dot is a customer. X-axis = days since last purchase (lower = more recent), Y-axis = total orders.
Color = RFM segment. Ideal customers appear in the top-left corner.`,Ot,_t,je,Dt,Te,Wt='<a href="#segment-performance-details">Segment Performance Details</a>',$t,mt,Je,bt,ft,wt,Ce,Yt='<a href="#average-ltv-by-segment">Average LTV by Segment</a>',kt,Ke,zt="Which customer segments generate the most value per person?",Mt,Ze,Ht,et,Ut;function Dr(e,t){return Jr}let ht=Dr()(s);F=new xr({props:{$$slots:{default:[Kr]},$$scope:{ctx:s}}});let T=s[0]&&dr(s);Q=new rt({props:{data:s[0],value:"total_cohorts",title:"Cohorts Analyzed"}}),j=new rt({props:{data:s[0],value:"total_customers",title:"Total New Customers",fmt:"#,##0"}}),I=new rt({props:{data:s[0],value:"avg_m1_retention",title:"Avg M1 Retention %",fmt:"#,##0.0"}}),K=new rt({props:{data:s[0],value:"avg_m3_retention",title:"Avg M3 Retention %",fmt:"#,##0.0"}});let C=s[1]&&pr(s);G=new Qr({props:{data:s[1],x:"period_number",y:"cohort_month",value:"retention_rate",title:"Cohort Retention Rate (%) — Period 0 to 12"}}),re=new Ft({props:{title:"How to read this heatmap",$$slots:{default:[Zr]},$$scope:{ctx:s}}});let y=s[2]&&Er(s);le=new vr({props:{data:s[2],x:"cohort_month",y:["m1_retention","m3_retention","m6_retention"],title:"Retention Rate by Cohort: Month 1 / 3 / 6",yAxisTitle:"Retention %",xAxisTitle:"Cohort Month"}});let O=s[3]&&Rr(s);Y=new hr({props:{data:s[3],x:"cohort_month",y:"new_customers",title:"New Customers per Cohort Month",yAxisTitle:"New Customers",xAxisTitle:"Cohort Month"}});let D=s[4]&&gr(s);pe=new vr({props:{data:s[4],x:"period_number",y:"cumulative_ltv_per_user",series:"cohort_month",title:"Cumulative LTV per Cohort Member (Last 8 Cohorts)",yAxisTitle:"Cumulative Revenue per User ($)",xAxisTitle:"Months Since First Purchase"}}),We=new Ft({props:{title:"LTV curve interpretation",$$slots:{default:[eo]},$$scope:{ctx:s}}});let $=s[5]&&Sr(s),b=s[6]&&Ar(s);Ye=new rt({props:{data:s[6],value:"total_customers",title:"Customers Segmented",fmt:"#,##0"}}),ze=new rt({props:{data:s[6],value:"overall_avg_ltv",title:"Overall Avg LTV",fmt:"$#,##0.00"}}),Pe=new rt({props:{data:s[6],value:"overall_avg_rfm",title:"Overall Avg RFM Score",fmt:"#,##0.0"}}),Xe=new Xr({props:{config:{tooltip:{trigger:"item",formatter:Cr},series:[{type:"treemap",roam:!1,leafDepth:1,label:{show:!0,formatter:yr,fontSize:12,fontWeight:"bold",color:"#fff"},upperLabel:{show:!1},itemStyle:{borderWidth:2,borderColor:"#fff"},data:s[5].map(Or)}]},height:420}});let w=s[7]&&Nr(s);je=new jr({props:{data:s[7],x:"recency_days",y:"order_count",series:"customer_segment",title:"Recency vs Frequency by Customer Segment",xAxisTitle:"Days Since Last Purchase (lower = more recent)",yAxisTitle:"Number of Orders"}});let k=s[8]&&Tr(s);return Je=new qr({props:{data:s[8],rows:"10"}}),Ze=new hr({props:{data:s[5],x:"customer_segment",y:"avg_ltv",title:"Average Lifetime Value by RFM Segment",yAxisTitle:"Avg LTV ($)",xAxisTitle:"Customer Segment",swapXY:"true"}}),et=new Ft({props:{title:"RFM segment definitions",$$slots:{default:[to]},$$scope:{ctx:s}}}),{c(){o=c(),ht.c(),n=E("meta"),r=E("meta"),_=cr(),v=c(),l=E("h1"),l.innerHTML=z,tt=c(),ue=E("p"),ue.innerHTML=vt,q=c(),A(F.$$.fragment),x=c(),T&&T.c(),X=c(),A(Q.$$.fragment),be=c(),A(j.$$.fragment),J=c(),A(I.$$.fragment),fe=c(),A(K.$$.fragment),we=c(),Ee=E("hr"),Z=c(),H=E("h2"),H.innerHTML=ke,Me=c(),ee=E("p"),ee.textContent=ot,te=c(),C&&C.c(),V=c(),A(G.$$.fragment),He=c(),A(re.$$.fragment),Ue=c(),P=E("hr"),oe=c(),B=E("h2"),B.innerHTML=nt,Le=c(),ne=E("p"),ne.textContent=he,se=c(),y&&y.c(),ae=c(),A(le.$$.fragment),Fe=c(),Re=E("hr"),ie=c(),U=E("h2"),U.innerHTML=Ie,qe=c(),_e=E("p"),_e.textContent=st,me=c(),O&&O.c(),W=c(),A(Y.$$.fragment),Be=c(),ge=E("hr"),Ve=c(),L=E("h2"),L.innerHTML=ve,de=c(),ce=E("p"),ce.innerHTML=at,Ge=c(),D&&D.c(),d=c(),A(pe.$$.fragment),dt=c(),A(We.$$.fragment),pt=c(),ut=E("hr"),Et=c(),Se=E("h2"),Se.innerHTML=It,Rt=c(),$&&$.c(),lt=c(),b&&b.c(),it=c(),A(Ye.$$.fragment),gt=c(),A(ze.$$.fragment),St=c(),A(Pe.$$.fragment),At=c(),Ae=E("h3"),Ae.innerHTML=qt,Nt=c(),xe=E("p"),xe.textContent=Bt,Tt=c(),A(Xe.$$.fragment),Ct=c(),Ne=E("h3"),Ne.innerHTML=Vt,yt=c(),Qe=E("p"),Qe.textContent=Gt,Ot=c(),w&&w.c(),_t=c(),A(je.$$.fragment),Dt=c(),Te=E("h3"),Te.innerHTML=Wt,$t=c(),k&&k.c(),mt=c(),A(Je.$$.fragment),bt=c(),ft=E("hr"),wt=c(),Ce=E("h2"),Ce.innerHTML=Yt,kt=c(),Ke=E("p"),Ke.textContent=zt,Mt=c(),A(Ze.$$.fragment),Ht=c(),A(et.$$.fragment),this.h()},l(e){o=m(e);const t=br("svelte-2igo1p",document.head);ht.l(t),n=p(t,"META",{name:!0,content:!0}),r=p(t,"META",{name:!0,content:!0}),_=cr(),t.forEach(a),v=m(e),l=p(e,"H1",{class:!0,id:!0,"data-svelte-h":!0}),N(l)!=="svelte-3kqhcs"&&(l.innerHTML=z),tt=m(e),ue=p(e,"P",{class:!0,"data-svelte-h":!0}),N(ue)!=="svelte-1tm42rv"&&(ue.innerHTML=vt),q=m(e),S(F.$$.fragment,e),x=m(e),T&&T.l(e),X=m(e),S(Q.$$.fragment,e),be=m(e),S(j.$$.fragment,e),J=m(e),S(I.$$.fragment,e),fe=m(e),S(K.$$.fragment,e),we=m(e),Ee=p(e,"HR",{class:!0}),Z=m(e),H=p(e,"H2",{class:!0,id:!0,"data-svelte-h":!0}),N(H)!=="svelte-estdgw"&&(H.innerHTML=ke),Me=m(e),ee=p(e,"P",{class:!0,"data-svelte-h":!0}),N(ee)!=="svelte-gz80w"&&(ee.textContent=ot),te=m(e),C&&C.l(e),V=m(e),S(G.$$.fragment,e),He=m(e),S(re.$$.fragment,e),Ue=m(e),P=p(e,"HR",{class:!0}),oe=m(e),B=p(e,"H2",{class:!0,id:!0,"data-svelte-h":!0}),N(B)!=="svelte-14dmakw"&&(B.innerHTML=nt),Le=m(e),ne=p(e,"P",{class:!0,"data-svelte-h":!0}),N(ne)!=="svelte-1lz5lmd"&&(ne.textContent=he),se=m(e),y&&y.l(e),ae=m(e),S(le.$$.fragment,e),Fe=m(e),Re=p(e,"HR",{class:!0}),ie=m(e),U=p(e,"H2",{class:!0,id:!0,"data-svelte-h":!0}),N(U)!=="svelte-19azecp"&&(U.innerHTML=Ie),qe=m(e),_e=p(e,"P",{class:!0,"data-svelte-h":!0}),N(_e)!=="svelte-1qr2hun"&&(_e.textContent=st),me=m(e),O&&O.l(e),W=m(e),S(Y.$$.fragment,e),Be=m(e),ge=p(e,"HR",{class:!0}),Ve=m(e),L=p(e,"H2",{class:!0,id:!0,"data-svelte-h":!0}),N(L)!=="svelte-oh0ryb"&&(L.innerHTML=ve),de=m(e),ce=p(e,"P",{class:!0,"data-svelte-h":!0}),N(ce)!=="svelte-151fzct"&&(ce.innerHTML=at),Ge=m(e),D&&D.l(e),d=m(e),S(pe.$$.fragment,e),dt=m(e),S(We.$$.fragment,e),pt=m(e),ut=p(e,"HR",{class:!0}),Et=m(e),Se=p(e,"H2",{class:!0,id:!0,"data-svelte-h":!0}),N(Se)!=="svelte-zv8lgr"&&(Se.innerHTML=It),Rt=m(e),$&&$.l(e),lt=m(e),b&&b.l(e),it=m(e),S(Ye.$$.fragment,e),gt=m(e),S(ze.$$.fragment,e),St=m(e),S(Pe.$$.fragment,e),At=m(e),Ae=p(e,"H3",{class:!0,id:!0,"data-svelte-h":!0}),N(Ae)!=="svelte-1ifwr8l"&&(Ae.innerHTML=qt),Nt=m(e),xe=p(e,"P",{class:!0,"data-svelte-h":!0}),N(xe)!=="svelte-1zqyyo"&&(xe.textContent=Bt),Tt=m(e),S(Xe.$$.fragment,e),Ct=m(e),Ne=p(e,"H3",{class:!0,id:!0,"data-svelte-h":!0}),N(Ne)!=="svelte-zx6yz7"&&(Ne.innerHTML=Vt),yt=m(e),Qe=p(e,"P",{class:!0,"data-svelte-h":!0}),N(Qe)!=="svelte-dbqu99"&&(Qe.textContent=Gt),Ot=m(e),w&&w.l(e),_t=m(e),S(je.$$.fragment,e),Dt=m(e),Te=p(e,"H3",{class:!0,id:!0,"data-svelte-h":!0}),N(Te)!=="svelte-n38zp1"&&(Te.innerHTML=Wt),$t=m(e),k&&k.l(e),mt=m(e),S(Je.$$.fragment,e),bt=m(e),ft=p(e,"HR",{class:!0}),wt=m(e),Ce=p(e,"H2",{class:!0,id:!0,"data-svelte-h":!0}),N(Ce)!=="svelte-1u8p14l"&&(Ce.innerHTML=Yt),kt=m(e),Ke=p(e,"P",{class:!0,"data-svelte-h":!0}),N(Ke)!=="svelte-o0poa0"&&(Ke.textContent=zt),Mt=m(e),S(Ze.$$.fragment,e),Ht=m(e),S(et.$$.fragment,e),this.h()},h(){h(n,"name","twitter:card"),h(n,"content","summary_large_image"),h(r,"name","twitter:site"),h(r,"content","@evidence_dev"),h(l,"class","markdown"),h(l,"id","-cohort-analysis--customer-lifetime-value"),h(ue,"class","markdown"),h(Ee,"class","markdown"),h(H,"class","markdown"),h(H,"id","cohort-retention-matrix"),h(ee,"class","markdown"),h(P,"class","markdown"),h(B,"class","markdown"),h(B,"id","retention-rate-trends"),h(ne,"class","markdown"),h(Re,"class","markdown"),h(U,"class","markdown"),h(U,"id","new-customer-acquisition-by-month"),h(_e,"class","markdown"),h(ge,"class","markdown"),h(L,"class","markdown"),h(L,"id","cumulative-ltv-curves-by-cohort"),h(ce,"class","markdown"),h(ut,"class","markdown"),h(Se,"class","markdown"),h(Se,"id","rfm-customer-segmentation"),h(Ae,"class","markdown"),h(Ae,"id","segment-size--value--treemap"),h(xe,"class","markdown"),h(Ne,"class","markdown"),h(Ne,"id","recency-vs-frequency-scatter-by-segment"),h(Qe,"class","markdown"),h(Te,"class","markdown"),h(Te,"id","segment-performance-details"),h(ft,"class","markdown"),h(Ce,"class","markdown"),h(Ce,"id","average-ltv-by-segment"),h(Ke,"class","markdown")},m(e,t){i(e,o,t),ht.m(document.head,null),Lt(document.head,n),Lt(document.head,r),Lt(document.head,_),i(e,v,t),i(e,l,t),i(e,tt,t),i(e,ue,t),i(e,q,t),g(F,e,t),i(e,x,t),T&&T.m(e,t),i(e,X,t),g(Q,e,t),i(e,be,t),g(j,e,t),i(e,J,t),g(I,e,t),i(e,fe,t),g(K,e,t),i(e,we,t),i(e,Ee,t),i(e,Z,t),i(e,H,t),i(e,Me,t),i(e,ee,t),i(e,te,t),C&&C.m(e,t),i(e,V,t),g(G,e,t),i(e,He,t),g(re,e,t),i(e,Ue,t),i(e,P,t),i(e,oe,t),i(e,B,t),i(e,Le,t),i(e,ne,t),i(e,se,t),y&&y.m(e,t),i(e,ae,t),g(le,e,t),i(e,Fe,t),i(e,Re,t),i(e,ie,t),i(e,U,t),i(e,qe,t),i(e,_e,t),i(e,me,t),O&&O.m(e,t),i(e,W,t),g(Y,e,t),i(e,Be,t),i(e,ge,t),i(e,Ve,t),i(e,L,t),i(e,de,t),i(e,ce,t),i(e,Ge,t),D&&D.m(e,t),i(e,d,t),g(pe,e,t),i(e,dt,t),g(We,e,t),i(e,pt,t),i(e,ut,t),i(e,Et,t),i(e,Se,t),i(e,Rt,t),$&&$.m(e,t),i(e,lt,t),b&&b.m(e,t),i(e,it,t),g(Ye,e,t),i(e,gt,t),g(ze,e,t),i(e,St,t),g(Pe,e,t),i(e,At,t),i(e,Ae,t),i(e,Nt,t),i(e,xe,t),i(e,Tt,t),g(Xe,e,t),i(e,Ct,t),i(e,Ne,t),i(e,yt,t),i(e,Qe,t),i(e,Ot,t),w&&w.m(e,t),i(e,_t,t),g(je,e,t),i(e,Dt,t),i(e,Te,t),i(e,$t,t),k&&k.m(e,t),i(e,mt,t),g(Je,e,t),i(e,bt,t),i(e,ft,t),i(e,wt,t),i(e,Ce,t),i(e,kt,t),i(e,Ke,t),i(e,Mt,t),g(Ze,e,t),i(e,Ht,t),g(et,e,t),Ut=!0},p(e,t){ht.p(e,t);const Pt={};t[2]&16&&(Pt.$$scope={dirty:t,ctx:e}),F.$set(Pt),e[0]?T?(T.p(e,t),t[0]&1&&u(T,1)):(T=dr(e),T.c(),u(T,1),T.m(X.parentNode,X)):T&&(Oe(),f(T,1,1,()=>{T=null}),ye());const xt={};t[0]&1&&(xt.data=e[0]),Q.$set(xt);const Xt={};t[0]&1&&(Xt.data=e[0]),j.$set(Xt);const Qt={};t[0]&1&&(Qt.data=e[0]),I.$set(Qt);const jt={};t[0]&1&&(jt.data=e[0]),K.$set(jt),e[1]?C?(C.p(e,t),t[0]&2&&u(C,1)):(C=pr(e),C.c(),u(C,1),C.m(V.parentNode,V)):C&&(Oe(),f(C,1,1,()=>{C=null}),ye());const Jt={};t[0]&2&&(Jt.data=e[1]),G.$set(Jt);const Kt={};t[2]&16&&(Kt.$$scope={dirty:t,ctx:e}),re.$set(Kt),e[2]?y?(y.p(e,t),t[0]&4&&u(y,1)):(y=Er(e),y.c(),u(y,1),y.m(ae.parentNode,ae)):y&&(Oe(),f(y,1,1,()=>{y=null}),ye());const Zt={};t[0]&4&&(Zt.data=e[2]),le.$set(Zt),e[3]?O?(O.p(e,t),t[0]&8&&u(O,1)):(O=Rr(e),O.c(),u(O,1),O.m(W.parentNode,W)):O&&(Oe(),f(O,1,1,()=>{O=null}),ye());const er={};t[0]&8&&(er.data=e[3]),Y.$set(er),e[4]?D?(D.p(e,t),t[0]&16&&u(D,1)):(D=gr(e),D.c(),u(D,1),D.m(d.parentNode,d)):D&&(Oe(),f(D,1,1,()=>{D=null}),ye());const tr={};t[0]&16&&(tr.data=e[4]),pe.$set(tr);const rr={};t[2]&16&&(rr.$$scope={dirty:t,ctx:e}),We.$set(rr),e[5]?$?($.p(e,t),t[0]&32&&u($,1)):($=Sr(e),$.c(),u($,1),$.m(lt.parentNode,lt)):$&&(Oe(),f($,1,1,()=>{$=null}),ye()),e[6]?b?(b.p(e,t),t[0]&64&&u(b,1)):(b=Ar(e),b.c(),u(b,1),b.m(it.parentNode,it)):b&&(Oe(),f(b,1,1,()=>{b=null}),ye());const or={};t[0]&64&&(or.data=e[6]),Ye.$set(or);const nr={};t[0]&64&&(nr.data=e[6]),ze.$set(nr);const sr={};t[0]&64&&(sr.data=e[6]),Pe.$set(sr);const ar={};t[0]&32&&(ar.config={tooltip:{trigger:"item",formatter:Cr},series:[{type:"treemap",roam:!1,leafDepth:1,label:{show:!0,formatter:yr,fontSize:12,fontWeight:"bold",color:"#fff"},upperLabel:{show:!1},itemStyle:{borderWidth:2,borderColor:"#fff"},data:e[5].map(Or)}]}),Xe.$set(ar),e[7]?w?(w.p(e,t),t[0]&128&&u(w,1)):(w=Nr(e),w.c(),u(w,1),w.m(_t.parentNode,_t)):w&&(Oe(),f(w,1,1,()=>{w=null}),ye());const lr={};t[0]&128&&(lr.data=e[7]),je.$set(lr),e[8]?k?(k.p(e,t),t[0]&256&&u(k,1)):(k=Tr(e),k.c(),u(k,1),k.m(mt.parentNode,mt)):k&&(Oe(),f(k,1,1,()=>{k=null}),ye());const ir={};t[0]&256&&(ir.data=e[8]),Je.$set(ir);const _r={};t[0]&32&&(_r.data=e[5]),Ze.$set(_r);const mr={};t[2]&16&&(mr.$$scope={dirty:t,ctx:e}),et.$set(mr)},i(e){Ut||(u(F.$$.fragment,e),u(T),u(Q.$$.fragment,e),u(j.$$.fragment,e),u(I.$$.fragment,e),u(K.$$.fragment,e),u(C),u(G.$$.fragment,e),u(re.$$.fragment,e),u(y),u(le.$$.fragment,e),u(O),u(Y.$$.fragment,e),u(D),u(pe.$$.fragment,e),u(We.$$.fragment,e),u($),u(b),u(Ye.$$.fragment,e),u(ze.$$.fragment,e),u(Pe.$$.fragment,e),u(Xe.$$.fragment,e),u(w),u(je.$$.fragment,e),u(k),u(Je.$$.fragment,e),u(Ze.$$.fragment,e),u(et.$$.fragment,e),Ut=!0)},o(e){f(F.$$.fragment,e),f(T),f(Q.$$.fragment,e),f(j.$$.fragment,e),f(I.$$.fragment,e),f(K.$$.fragment,e),f(C),f(G.$$.fragment,e),f(re.$$.fragment,e),f(y),f(le.$$.fragment,e),f(O),f(Y.$$.fragment,e),f(D),f(pe.$$.fragment,e),f(We.$$.fragment,e),f($),f(b),f(Ye.$$.fragment,e),f(ze.$$.fragment,e),f(Pe.$$.fragment,e),f(Xe.$$.fragment,e),f(w),f(je.$$.fragment,e),f(k),f(Je.$$.fragment,e),f(Ze.$$.fragment,e),f(et.$$.fragment,e),Ut=!1},d(e){e&&(a(o),a(v),a(l),a(tt),a(ue),a(q),a(x),a(X),a(be),a(J),a(fe),a(we),a(Ee),a(Z),a(H),a(Me),a(ee),a(te),a(V),a(He),a(Ue),a(P),a(oe),a(B),a(Le),a(ne),a(se),a(ae),a(Fe),a(Re),a(ie),a(U),a(qe),a(_e),a(me),a(W),a(Be),a(ge),a(Ve),a(L),a(de),a(ce),a(Ge),a(d),a(dt),a(pt),a(ut),a(Et),a(Se),a(Rt),a(lt),a(it),a(gt),a(St),a(At),a(Ae),a(Nt),a(xe),a(Tt),a(Ct),a(Ne),a(yt),a(Qe),a(Ot),a(_t),a(Dt),a(Te),a($t),a(mt),a(bt),a(ft),a(wt),a(Ce),a(kt),a(Ke),a(Mt),a(Ht)),ht.d(e),a(n),a(r),a(_),R(F,e),T&&T.d(e),R(Q,e),R(j,e),R(I,e),R(K,e),C&&C.d(e),R(G,e),R(re,e),y&&y.d(e),R(le,e),O&&O.d(e),R(Y,e),D&&D.d(e),R(pe,e),R(We,e),$&&$.d(e),b&&b.d(e),R(Ye,e),R(ze,e),R(Pe,e),R(Xe,e),w&&w.d(e),R(je,e),k&&k.d(e),R(Je,e),R(Ze,e),R(et,e)}}}const Cr=function(s){return"<b>"+s.name+"</b><br/>Customers: "+s.value.toLocaleString()+"<br/>Avg LTV: $"+(s.data.avg_ltv||0).toFixed(2)+"<br/>Total Revenue: $"+((s.data.total_revenue||0)/1e3).toFixed(0)+"k"},yr=function(s){return s.name+`
`+s.value.toLocaleString()},Or=function(s){var o={Champions:"#16a34a","Loyal Customers":"#2563eb","Potential Loyalists":"#7c3aed","New Customers":"#0891b2","Needs Attention":"#d97706","At Risk":"#ea580c","Cannot Lose Them":"#dc2626",Lost:"#4b5563"};return{name:s.customer_segment,value:s.customers,avg_ltv:s.avg_ltv,total_revenue:s.total_segment_revenue,itemStyle:{color:o[s.customer_segment]||"#94a3b8"}}};function oo(s,o,n){let r,_;ur(s,Pr,d=>n(47,r=d)),ur(s,fr,d=>n(53,_=d));let{data:v}=o,{data:l={},customFormattingSettings:z,__db:tt,inputs:ue}=v;wr(fr,_="a77688e729659b02fd5c916ab623cf1c",_);let vt=Br(Yr(ue));kr(vt.subscribe(d=>ue=d)),Mr(Wr,{getCustomFormats:()=>z.customFormats||[]});const q=(d,pe)=>zr(tt.query,d,{query_name:pe});Vr(q),r.params,Hr(()=>!0);let F={initialData:void 0,initialError:void 0},x=M`SELECT
...
FROM cohort_retention`,X=`SELECT
  ...
  ROUND(AVG(CASE WHEN period_number = 1 THEN retention_rate END), 1) AS avg_m1_retention,
  ROUND(AVG(CASE WHEN period_number = 3 THEN retention_rate END), 1) AS avg_m3_retention
FROM cohort_retention`;l.cohort_kpis_data&&(l.cohort_kpis_data instanceof Error?F.initialError=l.cohort_kpis_data:F.initialData=l.cohort_kpis_data,l.cohort_kpis_columns&&(F.knownColumns=l.cohort_kpis_columns));let Q,be=!1;const j=De.createReactive({callback:d=>{n(0,Q=d)},execFn:q},{id:"cohort_kpis",...F});j(X,{noResolve:x,...F}),globalThis[Symbol.for("cohort_kpis")]={get value(){return Q}};let J={initialData:void 0,initialError:void 0},I=M`SELECT
  cohort_month,
  period_number,
  retention_rate
...
FROM cohort_retention
WHERE period_number = 0
ORDER BY cohort_month`;l.cohort_sizes_data&&(l.cohort_sizes_data instanceof Error?te.initialError=l.cohort_sizes_data:te.initialData=l.cohort_sizes_data,l.cohort_sizes_columns&&(te.knownColumns=l.cohort_sizes_columns));let He,re=!1;const Ue=De.createReactive({callback:d=>{n(3,He=d)},execFn:q},{id:"cohort_sizes",...te});Ue(G,{noResolve:V,...te}),globalThis[Symbol.for("cohort_sizes")]={get value(){return He}};let P={initialData:void 0,initialError:void 0},oe=M`WITH recent_cohorts AS (
...
FROM customer_ltv
GROUP BY customer_segment
ORDER BY total_segment_revenue DESC`;l.segment_summary_data&&(l.segment_summary_data instanceof Error?he.initialError=l.segment_summary_data:he.initialData=l.segment_summary_data,l.segment_summary_columns&&(he.knownColumns=l.segment_summary_columns));let le,Fe=!1;const Re=De.createReactive({callback:d=>{n(5,le=d)},execFn:q},{id:"segment_summary",...he});Re(ae,{noResolve:se,...he}),globalThis[Symbol.for("segment_summary")]={get value(){return le}};let ie={initialData:void 0,initialError:void 0},U=M`SELECT
...
WHERE order_count <= 25
  AND recency_days <= 500
ORDER BY total_revenue DESC
LIMIT 3000`;l.rfm_scatter_data&&(l.rfm_scatter_data instanceof Error?me.initialError=l.rfm_scatter_data:me.initialData=l.rfm_scatter_data,l.rfm_scatter_columns&&(me.knownColumns=l.rfm_scatter_columns));let Be,ge=!1;const Ve=De.createReactive({callback:d=>{n(7,Be=d)},execFn:q},{id:"rfm_scatter",...me});Ve(Y,{noResolve:W,...me}),globalThis[Symbol.for("rfm_scatter")]={get value(){return Be}};let L={initialData:void 0,initialError:void 0},ve=M`SELECT
  customer_segment,
  COUNT(*) AS customers,
  ROUND(AVG(total_revenue), 2) AS avg_ltv,
  ROUND(SUM(total_revenue), 2) AS total_segment_revenue,
...
FROM customer_ltv
GROUP BY customer_segment
ORDER BY total_segment_revenue DESC`),[Q,K,Me,He,nt,le,qe,Be,ce,v,l,F,x,X,be,J,I,fe,we,Z,H,ke,ee,te,V,G,re,P,oe,B,Le,he,se,ae,Fe,ie,U,Ie,_e,me,W,Y,ge,L,ve,de,at,r]}class Ro extends Fr{constructor(o){super(),Ir(this,o,oo,ro,$r,{data:9},null,[-1,-1,-1])}}export{Ro as component};
